...
@endcan
@can('products.show')
<a href="{{ route('products.show', $uuid) }}" class="text-info me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ trans('page.products.show') }}"><i class="fa fa-sm fa-eye"></i></a>
@endcan
